                                ...
                                <section class="home-kv-carousel  home-kv-carousel--height-medium"
                                    ...
                                    <div class="home-kv-carousel__container">
                                        ...
                                        <div class="home-kv-carousel__wrapper">
                                            <!-- ========================================  SLIDE DAU  ========================================================== -->
                                            <div class="home-kv-carousel__slide bg-white" id="home-kv-carousel-slide-1"
                                                role="tabpanel" an-tr="hd01_home kv carousel-home-image-swipe1"
                                            ...
                                            <!-- ========================================  SLIDE DAU  ========================================================== -->
                                            <!-- ========================================  VIDEO  ========================================================== -->
                                            <div class="home-kv-carousel__slide bg-white" id="home-kv-carousel-slide-2"
                                                role="tabpanel" an-tr="hd01_home kv carousel-home-image-swipe2"
                                            ...
                                            <!-- =========================================  END VIDEO  ========================================================== -->
                                            <div class="home-kv-carousel__slide bg-white" id="home-kv-carousel-slide-3"
                                                role="tabpanel" an-tr="hd01_home kv carousel-home-image-swipe3"
                                        ...
                                        <div class="indicator label-indicator" data-indicator-data='{
                                            ...
                                            <div class="indicator-wrap">
                                                <button style="display: none;"
                                                    ...
                                                    an-tr="hd01_home kv carousel-home-image-action" an-ca="indication"
                                                    an-ac="carousel" an-la="carousel:index:kv play">
                                                    ----
