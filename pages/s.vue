                                        ...
                                        <div class="home-kv-carousel__container">
                                            ...
                                            <div class="home-kv-carousel__wrapper">
                                                ...
                                                <div class="home-kv-carousel__slide bg-white"
                                                    ...
                                                    an-tr="hd01_home kv carousel-home-image-swipe1" an-ca="indication"
                                                    an-ac="carousel" an-la="carousel:swipe:kv1">
                                                            ...
                                                            <figure class="first-image">
                                                                <picture>
                                                                    <source media="(max-width:767px)"
                                                                        srcset="https://thegioidilac.shop/_nuxt/img/bg_app.da6a8cd.png" />
                                                                    <source
                                                ...
                                                <div class="home-kv-carousel__slide bg-white"
                                                    ...
                                                    an-tr="hd01_home kv carousel-home-image-swipe2" an-ca="indication"
                                                    an-ac="carousel" an-la="carousel:swipe:kv2">
                                                    <div class="home-kv-carousel__slide-inner">
                                                        <div
                                                ...
                                                <div class="home-kv-carousel__slide bg-white"
                                                    ...
                                                    an-ac="carousel" an-la="carousel:swipe:kv3">
                                                    <div class="home-kv-carousel__slide-inner">
                                                        <div
                                                            class="home-kv-carousel__text-wrap text-color--black home-kv-carousel__text-wrap--desktop-middle-left home-kv-carousel__text-wrap--mobile-top-center  ">
                                                            <h2 class="home-kv-carousel__headline"
                                            ...
                                            <div class="arrow-indicator-wrap">
                                                <button
                                                    ...
                                                    an-tr="hd01_home kv carousel-home-image-arrow" an-ca="indication"
                                                    an-ac="carousel" an-la="carousel:arrow:kv left">
                                                ...
                                                <button
                                                    ...
                                                    an-tr="hd01_home kv carousel-home-image-arrow" an-ca="indication"
                                                    an-ac="carousel" an-la="carousel:arrow:kv right">
